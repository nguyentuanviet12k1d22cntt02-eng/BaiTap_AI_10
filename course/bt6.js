...
- Xuất khối mã hoàn chỉnh cho file "6_BackendService.gs", có phản hồi kết quả thành công để thông báo cho người dùng.`
      ...
      {
        badge: "07",
        title: "Bước 7: Tạo File 0_GuiEmailGiaLap_Bank.gs (Mã Nguồn Có Sẵn - Gửi 3 Email Test Vào Gmail)",
        desc: "Thao tác: Bấm dấu (+) chọn Script ➔ Đặt tên file là <code>0_GuiEmailGiaLap_Bank.gs</code> ➔ <b>Sao chép trực tiếp đoạn mã có sẵn bên dưới</b> và bấm Chạy hàm <code>guiBoEmailBienLaiMauDeTest</code> (Không cần prompt AI).",
        boxTitle: "Mã Nguồn File 0_GuiEmailGiaLap_Bank.gs (Sao Chép & Dán Chạy Trực Tiếp)",
        boxIcon: "ph-code",
        promptBox: `/**
 * ==============================================================================
