...
### 📨 BƯỚC 7: TẠO FILE 0_GuiEmailGiaLap_Bank.gs (GỬI 3 EMAIL BIÊN LAI MẪU ĐỂ TEST)

* **Thao tác:** Mở Apps Script ➔ Bấm dấu `+` ➔ chọn **Script** ➔ Đặt tên file là `0_GuiEmailGiaLap_Bank.gs`.
* **Câu Prompt Bước 7:**
